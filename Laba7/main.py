import telebot
import cfgg
from wek import curr_week_for_bd, curr_week
from db import get_day_formatting, get_week_formatting

token = "6134973703:AAF1JjEgabG06iWlrq-8LXsmHJLOw26T_Q8"
...
def help_bot(message):
    bot.send_message(message.chat.id, text=cfgg.help_txt)
